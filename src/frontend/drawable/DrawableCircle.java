...
public class DrawableCircle extends Circle implements DrawableFigureOval{
    ...
    public DrawableCircle(Point centerPoint, double radius, ShadowType shadow, boolean gradient, boolean bevel, Color color1, Color color2){
        super(centerPoint, radius, shadow, gradient, bevel, color1, color2);
    }

    public void draw(GraphicsContext gc, boolean isSelected){
        drawOval(shadow, gradient, bevel, gc, color1, color2, isSelected, centerPoint, getRadius(), getRadius());
    }
