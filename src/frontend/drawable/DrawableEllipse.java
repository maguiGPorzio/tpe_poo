...
public class DrawableEllipse extends Ellipse implements DrawableFigureOval {
    ...
    public DrawableEllipse(Point centerPoint, double sMayorAxis, double sMinorAxis, Shadow shadow, boolean gradient, boolean bevel, Color color1, Color color2){
    ...
    public void draw(GraphicsContext gc, Color lineColor, boolean isSelected){
        drawOval(this.shadow, this.hasGradient(), this.hasBevel(), gc, lineColor, this.color1, this.color2, isSelected, centerPoint, sMayorAxis/2, sMinorAxis/2);
    }
